      ...
      <Content>
        <div>
          <HelpPost className="noselect">
            <a href="https://github.com/MelisseCabral/devsh" target="_blank" className="logo" rel="noreferrer">
              Help us!
            </a>
          </HelpPost>
          ...
          <FooterNote className="noselect">
            <span>
              ...
              <Emoji>❤️</Emoji>
              <span>{' by: '}</span>
              <a href="https://github.com/MelisseCabral" target="_blank" rel="noreferrer">
                Melisse Cabral
              </a>
            </span>
          </FooterNote>
